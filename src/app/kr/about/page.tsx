...
export default function AboutPage() {
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <h1 className="text-3xl md:text-5xl font-bold text-center mb-10">소개</h1>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            <div className={memberImageWrapperClassName}>
              <Image src="/images/member-5.jpg" alt="Member Name 4" width={150} height={150} className={memberImageClassName} />
            </div>
            <h3 className="text-xl font-bold">
